const dictionary = {
  ...
  "junaid" : {
    ...
    "definition" : "Junaid is a teenager , Who likes coding. He made cusor.js , ShowData.js ,  junaid-app-store(Online App uploading platform for free),\nJunaid-web-hosting(Online Web Hosting Platform),Junaid-app-hosting(It is a branch of Junaid-web-hosting) , Flight Simulator(Online 2D Simulator and Game) , DictionaryApp (Online Version) , DictionaryApp 2 (Offline Version of DictionaryApp)"
  }
}
